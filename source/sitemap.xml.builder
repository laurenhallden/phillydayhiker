...
xml.urlset "xmlns" => "http://www.sitemaps.org/schemas/sitemap/0.9" do
  ...
  sitemap.resources.each do |page|
      ...
      throw :next_page if page.url.start_with?('/contact/thanks/')
      throw :next_page if page.url.start_with?('/pattern_library/')
      throw :next_page if page.url.start_with?('/fonts/')
      throw :next_page if page.url.start_with?('/go/')
      throw :next_page if page.url.start_with?('/404')
      ...
      xml.url do
        xml.loc 'https://www.stitchdata.com' + page.url   # TODO: possibly remove .html
